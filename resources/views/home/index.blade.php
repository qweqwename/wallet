...
<head>
    ...
    <script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-TX8M7DF"></script>
    <script type="text/javascript" async=""
            src="https://www.googletagmanager.com/gtag/js?id=G-8PK1MGQ8EX&amp;l=dataLayer&amp;cx=c"></script>
    <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script>
    <script type="text/javascript" async="" src="https://mc.yandex.ru/metrika/tag.js"></script>
    <script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-TX8M7DF"></script>
    <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script>
    <script type="text/javascript" async="" src="https://mc.yandex.ru/metrika/tag.js"></script>
    <script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-TX8M7DF"></script>
    <script defer="" data-domain="tabler.io" src="https://plausible.io/js/plausible.js"></script>
    ...
    <script async="" src="https://www.googletagmanager.com/gtag/js?id=G-8PK1MGQ8EX"></script>
    <script>
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TX8M7DF" height="0" width="0"
...
<div class="page">
    <header class="header js-header">
        <div class="container">
            <div class="d-flex align-items-center position-relative">
                <a href="/" class="logo">
                    <img src="images/wallet.svg" alt="Tabler UI Kit" title="">
                    <div>{{_('Мой кошелек')}}</div>
                </a>
                ...
                <nav class="ml-auto header-nav d-md-block d-none">
                    <a style="float: left;" href="{{route('login')}}" rel="nofollow">
                        <div>{{_('Войти')}}</div>
                    </a>
                    <a style="float: left;" href="{{route('register')}}" rel="nofollow">
                        <div>{{_('Быстрая регистрация')}}</div>
                    </a>
                </nav>
            </div>
        </div>
    ...
    <main class="main">
        <section class="welcome welcome-blue text-white" aria-label="Page header" style="
    /* height: 100vh; */
    padding: 8rem 0 9rem;
    height: 100vh;
">
...
">
                                    <picture>
                                        <img src="images/wallet.svg" alt="Preview of tabler dashboard"
...
<noscript>
    <div><img src="https://mc.yandex.ru/watch/51402697" style="position:absolute; left:-9999px;" alt=""></div>
</noscript>
<script>!function (n) {
        "use strict";
