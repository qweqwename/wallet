...
return [
    ...
    'custom'               => [
        'id' => [
            ...
            'numeric' => 'Введите правильно кошелек',
        ],
        'password' => [
            'required' => 'Поле пароль обязательно',
        ],
        'fee' => [
            'required' => 'Неправильное значение для комиссии',
            'between' => 'Комиссия может быть в диапазоне :min% - :max%',
        ],
        'amount' => [
            'required' => 'Укажите сумму перевода',
            'numeric' => 'Введена неправильная сумма перевода',
            'min' => 'Сумма перевода должна быть не меньше :min',
        ],
        'amount_replenish' => [
            'required' => 'Укажите сумму пополнения',
            'numeric' => 'Введена неправильная сумма пополнения',
            'min' => 'Сумма пополнения должна быть не меньше :min',
            'regex' => 'Введена неправильная сумма пополнения',
        ],

        'new_password' => [
            'min' => 'Длина пароля должна быть более 6 символов',
            'max' => 'Длина пароля должна быть менее 100 символов',
        ]
    ],
